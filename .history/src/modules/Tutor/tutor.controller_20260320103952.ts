...
const getTutorAccount = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await TutorService.getTutorAccount(req.params);
        res.status(201).json({
            success: true,
...
const getAllTutorAccount = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const result = await TutorService.getAllTutorAccount(req.params);
        res.status(201).json({
            success: true,
            massage: "Tutor account retrieved successfully.",
            data: result
